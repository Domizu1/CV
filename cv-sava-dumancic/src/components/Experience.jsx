    ...
    return(
        ...
        <div className="flex justify-between items-start w-full mx-auto gap-6 mt-6">
            <div className="flex-1">
                ...
                <h1 className="text-xl opacity-90 font-semibold">Better Collective</h1>
                <h3 className="text-lg mt-1 opacity-70">Ad Tech Specialist</h3>
                <span className="text-xs opacity-50">2023 - present</span>
                <div className="border-b border-gray-500/80 my-2"></div>
                <p className="mt-4 text-sm list-disc list-inside tracking-wide textspace-y-1">
            ...
            <div className="text-white bg-[#384358] rounded-xl w-[450px] h-[300px] p-4">
                <h1 className="text-xl opacity-90 font-semibold">Syrmia Way (Now part of AMD)</h1>
                <h3 className="text-lg mt-1 opacity-70">Practicant (Paid Internship)</h3>
                <span className="text-xs opacity-50">2021 - 2023</span>
                <div className="border-b border-gray-500/80 my-2"></div>
                <p className="mt-4 text-sm list-disc list-inside tracking-wide textspace-y-1">
